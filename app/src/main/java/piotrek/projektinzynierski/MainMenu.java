    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edycja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Imgproc.GaussianBlur(imageGrayScale, imageBlurred, new Size(11, 11), 2);
                //Imgproc.adaptiveThreshold(imageBlurred, imageThresholded, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C, Imgproc.THRESH_BINARY, 11, 1);
                Imgproc.Canny(imageBlurred, imageCanny, 40,120);
                //Imgproc.Laplacian(imageThresholded, imageLaplacian, 0, 11, 1, 0);
                Bitmap myBitmap = Bitmap.createBitmap(imageGrayScale.width(),imageGrayScale.height(), Bitmap.Config.ARGB_8888);
                Utils.matToBitmap(imageCanny, myBitmap);
